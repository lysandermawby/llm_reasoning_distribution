#!/usr/bin/env python3
"""finds the word distribution of the thinking and non-thinking text in the medical-o1-reasoning-SFT dataset"""
...
def main(save_dict, plot, individual):
    """process data for medical-o1-reasoning-SFT dataset"""
    ...
    data_path = Path("data") / "medical-o1-reasoning-SFT.jsonl"
    ...
    for entry in json_data:
        text_chunks.append(entry["Complex_CoT"])

    # prevent individual plots. option preserved for compatability with shell automation
    if individual:
        print("Warning: Setting individual=false as the data in medical-o1-reasoning-SFT does not have a distinction between regular and thinking text")
        individual=False

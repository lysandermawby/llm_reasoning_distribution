#!/usr/bin/env python3
"""downloading the medical-o1-reasoning-SFT dataset"""
...
def main(number, download_all):
    """download FreedomIntelligence/medical-o1-reasoning-SFT dataset from HuggingFace"""
    ...
    download_utils.download_hf_dataset_streaming(
        hf_repo_name="FreedomIntelligence/medical-o1-reasoning-SFT",
        data_dir=Path("data"),
        output_filename="medical-o1-reasoning-SFT.jsonl",
        n=number,
        name="en"  # Use English subset
    )

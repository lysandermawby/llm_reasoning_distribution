#!/usr/bin/env python3
"""downloading the NuminaMath-QwQ-CoT-5M dataset"""
...
def main(number, download_all):
    """download PrimeIntellect/NuminaMath-QwQ-CoT-5M dataset from HuggingFace"""
    ...
    download_utils.download_hf_dataset_streaming(
        hf_repo_name="PrimeIntellect/NuminaMath-QwQ-CoT-5M",
        output_filename="NuminaMath-QwQ-CoT-5M.jsonl",
        data_dir=Path("data"),
        n=number
    )
